require([
    ...
    let featureLayer = new FeatureLayer({
        url: "http://localhost:6080/arcgis/rest/services/app/Element2/FeatureServer/0",
        outFields : ["*"]
    });
    ...
    let displayResults = function(data) {
        ...
        for(let x in data.features) {
            ...
            let tableRow = `<tr>
                    ...
                    <td>${data.features[x].attributes.route}</td>
                    <td>
        ...
        if(e.target.className.toLowerCase() === 'btn btn-default') {
            ...
            commitEdit.onclick = function() {
                ...
                queryStationByOid(targetId).then(function(data) {
                    ...
                    updateFeature.attributes.route = route.value;
